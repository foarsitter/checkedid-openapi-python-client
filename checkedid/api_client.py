...
from checkedid import rest
from checkedid.configuration import Configuration
from checkedid.exceptions import ApiException, ApiTypeError, ApiValueError
from checkedid.model_utils import (ModelComposed, ModelNormal, ModelSimple,
...
class Endpoint:
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.oauth_token_post  # this is an instance of the class Endpoint
        api_instance.oauth_token_post()  # this invokes api_instance.oauth_token_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.oauth_token_post.callable or self.callable in this class
